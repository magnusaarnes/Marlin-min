 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD // Changed
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH               1.5   // (mm) Default retract length (positive value) // Changed
  #define RETRACT_LENGTH_SWAP          13   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE             7200   // (mm/s) Default feedrate for retracting // Changed
  #define RETRACT_ZRAISE                0.2   // (mm) Default retract Z-raise // Changed
